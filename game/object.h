...
typedef enum {
  ...
  OBJECT_ANIM_BOSS2_STAND_RIGHT = OBJECT_ANIM_BOSS_HIT_RIGHT + 1,
  OBJECT_ANIM_BOSS2_RUN_RIGHT = OBJECT_ANIM_BOSS2_STAND_RIGHT + OBJECT_RUN_RIGHT,
  OBJECT_ANIM_BOSS2_STAND_LEFT = OBJECT_ANIM_BOSS2_STAND_RIGHT + OBJECT_STAND_LEFT,
  OBJECT_ANIM_BOSS2_RUN_LEFT  = OBJECT_ANIM_BOSS2_STAND_RIGHT + OBJECT_RUN_LEFT,
  OBJECT_ANIM_BOSS2_ATTACK_LEFT1  = OBJECT_ANIM_BOSS2_STAND_RIGHT + OBJECT_PUNCH_LEFT1,
  OBJECT_ANIM_BOSS2_ATTACK_LEFT2  = OBJECT_ANIM_BOSS2_STAND_RIGHT + OBJECT_PUNCH_LEFT2,
  OBJECT_ANIM_BOSS2_ATTACK_RIGHT1  = OBJECT_ANIM_BOSS2_STAND_RIGHT + OBJECT_PUNCH_RIGHT1,
  OBJECT_ANIM_BOSS2_ATTACK_RIGHT2  = OBJECT_ANIM_BOSS2_STAND_RIGHT + OBJECT_PUNCH_RIGHT2,  
  OBJECT_ANIM_BOSS2_HIT_LEFT  = OBJECT_ANIM_BOSS2_STAND_RIGHT + OBJECT_HIT_LEFT,
  OBJECT_ANIM_BOSS2_HIT_RIGHT  = OBJECT_ANIM_BOSS2_STAND_RIGHT + OBJECT_HIT_RIGHT,    

  OBJECT_ANIM_MOTORBIKE_STAND_RIGHT = OBJECT_ANIM_BOSS2_HIT_RIGHT + 1,
