...
typedef enum {
  ...
  OBJECT_ANIM_GUNFIGHTER_STAND_RIGHT = OBJECT_ANIM_BOSS_HIT_RIGHT + 1,
  OBJECT_ANIM_GUNFIGHTER_RUN_RIGHT = OBJECT_ANIM_GUNFIGHTER_STAND_RIGHT + OBJECT_RUN_RIGHT,
  OBJECT_ANIM_GUNFIGHTER_STAND_LEFT = OBJECT_ANIM_GUNFIGHTER_STAND_RIGHT + OBJECT_STAND_LEFT,
  OBJECT_ANIM_GUNFIGHTER_RUN_LEFT  = OBJECT_ANIM_GUNFIGHTER_STAND_RIGHT + OBJECT_RUN_LEFT,
  OBJECT_ANIM_GUNFIGHTER_ATTACK_LEFT1  = OBJECT_ANIM_GUNFIGHTER_STAND_RIGHT + OBJECT_PUNCH_LEFT1,
  OBJECT_ANIM_GUNFIGHTER_ATTACK_LEFT2  = OBJECT_ANIM_GUNFIGHTER_STAND_RIGHT + OBJECT_PUNCH_LEFT2,
  OBJECT_ANIM_GUNFIGHTER_ATTACK_RIGHT1  = OBJECT_ANIM_GUNFIGHTER_STAND_RIGHT + OBJECT_PUNCH_RIGHT1,
  OBJECT_ANIM_GUNFIGHTER_ATTACK_RIGHT2  = OBJECT_ANIM_GUNFIGHTER_STAND_RIGHT + OBJECT_PUNCH_RIGHT2,  
  OBJECT_ANIM_GUNFIGHTER_HIT_LEFT  = OBJECT_ANIM_GUNFIGHTER_STAND_RIGHT + OBJECT_HIT_LEFT,
  OBJECT_ANIM_GUNFIGHTER_HIT_RIGHT  = OBJECT_ANIM_GUNFIGHTER_STAND_RIGHT + OBJECT_HIT_RIGHT,    

  OBJECT_ANIM_MOTORBIKE_STAND_RIGHT = OBJECT_ANIM_GUNFIGHTER_HIT_RIGHT + 1,
  ...
  OBJECT_ANIM_SIXPACK1 = OBJECT_ANIM_BONUS_COLA + 1,
