...
#define SCREEN_HEIGHT         MAP_TILE_HEIGHT*TILE_HEIGHT
#define MESSAGE_SCREEN_WIDTH  SCREEN_WIDTH
#define MESSAGE_SCREEN_HEIGHT 256
#define MENU_SCREEN_HEIGHT    256

#define FRAME_BUFFER_OFFSCREEN_HEIGHT 16
#define FRAME_BUFFER_NUM_LINES ((SCREEN_HEIGHT+FRAME_BUFFER_OFFSCREEN_HEIGHT))
...
#define SPRITE_SHEET_HEIGHT 360
...
#define MESSAGE_SCREEN_WIDTH_BYTES (MESSAGE_SCREEN_WIDTH/8)
...
#define MENU_RASTER_Y_STOP  RASTER_Y_START+256
